...
public class TerrariumContainer extends Container
{
    ...
    public TerrariumContainer(InventoryPlayer inventoryPlayer, TileEntityTerrarium terrarium)
    {
        ...
        this.addSlotToContainer(new SeedSlot(terrarium, 0, 42, 24));
        this.addSlotToContainer(new GroundSlot(terrarium, 1, 42, 45));
        this.addSlotToContainer(new ProduceSlot(terrarium, 2, 92, 26));
        this.addSlotToContainer(new ProduceSlot(terrarium, 3, 110, 26));
        this.addSlotToContainer(new ProduceSlot(terrarium, 4, 92, 44));
        this.addSlotToContainer(new ProduceSlot(terrarium, 5, 110, 44));
